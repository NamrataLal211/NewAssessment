import { Typography, Box, Grid, Divider, IconButton, Button , Radio} from '@mui/material';
...
export default function Layout2(){
    ...
    return(
        <Grid container>
          <Grid item xs={12} lg={10} padding='2%'>
             ...
             <Grid backgroundColor='#25d366'>
                <Typography variant='h5' padding='2%' color='white'>MULTIPLE CHOICE QUESTION ASSESSMENT</Typography>
            </Grid>
        ...
        <Grid item xs={12}>
          <Languages type={<Radio sx={{margin:'1% 0%'}}/>}/>
        </Grid>
